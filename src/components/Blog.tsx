const posts = [
  {
    ...
    date: '12 мая 2026',
    title: 'Что меняется в законодательстве о ООО в 2026 году',
    excerpt: 'Обзор ключевых поправок в ФЗ «Об обществах с ограниченной ответственностью», которые вступают в силу в этом году.',
    readTime: '5 мин',
  },
  {
    tag: 'Налоговое право',
    date: '4 мая 2026',
    title: 'Как защититься при налоговой проверке: пошаговая инструкция',
    excerpt: 'Права налогоплательщика, обязательные процедуры ФНС и типичные ошибки предпринимателей при взаимодействии с инспекцией.',
    readTime: '8 мин',
  },
  {
    tag: 'Недвижимость',
    date: '25 апреля 2026',
    title: 'Риски при покупке коммерческой недвижимости: что проверить',
    excerpt: 'Юридическая проверка объекта, скрытые обременения, история права собственности — на что обратить внимание перед сделкой.',
    readTime: '6 мин',
  },
];
    ...
    <section id="blog" className="py-28" style={{ background: 'var(--white)' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
          ...
          >
            Актуальные разборы изменений в законодательстве и советы для бизнеса.
          </p>
        </div>
