...
const areas = [
  'Страховые выплаты (ранение, гибель)',
  'Статус ветерана боевых действий',
  'Льготы и компенсации',
  'Жильё военнослужащего',
  'Помощь семье погибшего',
  'Уголовная защита военного',
  'Оспаривание приказов и решений',
  'Другое',
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="font-golos text-base leading-relaxed mb-10" style={{ color: 'rgba(248,246,242,0.65)' }}>
              Первичная консультация — бесплатно. Расскажите о ситуации, и мы оценим ваши шансы на получение выплат или льгот.
            </p>

            <div className="flex flex-col gap-6">
              {[
                { icon: 'BadgeCheck', text: 'Первичная консультация — бесплатно' },
                { icon: 'Video', text: 'Онлайн или по телефону — из любой точки России' },
