...
const values = [
  { icon: 'Target', title: 'Результат', desc: 'Ставим конкретные цели и достигаем их. Ваш успех — наш приоритет.' },
  { icon: 'Eye', title: 'Прозрачность', desc: 'Честно информируем о перспективах дела и стоимости услуг на каждом этапе.' },
  { icon: 'Clock', title: 'Оперативность', desc: 'Реагируем быстро. Ваши юридические вопросы не ждут.' },
];

const team = [
  { name: 'Алексей Конкорин', role: 'Управляющий партнёр', area: 'Корпоративное право', exp: '18 лет' },
  { name: 'Мария Воронова', role: 'Старший партнёр', area: 'Судебная защита', exp: '14 лет' },
  { name: 'Дмитрий Захаров', role: 'Партнёр', area: 'Налоговое право', exp: '11 лет' },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div>
            ...
            >
              КОНКОР — это команда опытных юристов, объединённых одной целью: защищать ваши права максимально эффективно. Мы работаем с бизнесом любого масштаба и с частными клиентами, сочетая глубокую экспертизу с индивидуальным подходом к каждому делу.
            </p>
            <p
              className="font-golos text-base leading-loose mt-4"
              style={{ color: 'rgba(248,246,242,0.55)' }}
            >
              Наши специалисты — выпускники ведущих юридических вузов страны с многолетней практикой в российских и международных судах.
            </p>
          </div>
        </div>
